				      ...
				      u16 h_active, int enable_present)
{
	...
	__raw_writel(BF_LCDIF_CTRL1_BYTE_PACKING_FORMAT(0xf) |//7
	...
	__raw_writel(BM_LCDIF_CTRL_WORD_LENGTH |
		     ...
		     REGS_LCDIF_BASE + HW_LCDIF_CTRL_CLR);
	__raw_writel(BF_LCDIF_CTRL_WORD_LENGTH(0) |	/* 0:16bit 3:24 bit */
		     BM_LCDIF_CTRL_DATA_SELECT |	/* data mode */
		     BF_LCDIF_CTRL_INPUT_DATA_SWIZZLE(0) |	/* no swap */
		     BF_LCDIF_CTRL_LCD_DATABUS_WIDTH(0),  /*0:16bit 3:24 bit */
		     REGS_LCDIF_BASE + HW_LCDIF_CTRL_SET);
