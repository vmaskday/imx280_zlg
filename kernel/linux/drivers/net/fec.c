...
static int fec_enet_mii_probe(struct net_device *dev)
{
	...
	//for (phy_addr = 0; phy_addr < PHY_MAX_ADDR; phy_addr++) { //modefy by zhuguojun
	for (phy_addr = PHY_MAX_ADDR; phy_addr > -1 ; phy_addr--) { //eth0的phy地址是0x05 eth1的phy地址是0x01，反过来了，所以只反过来扫描
